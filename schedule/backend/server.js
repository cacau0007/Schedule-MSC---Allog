...
app.post('/api/export', async (req, res) => {
    ...
    try {
        ...
        sheet.getCell('A1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFFFD700' } };
        ...
        // Dados
        (sailings || []).forEach(s => {
            const etdFormatted = formatDateExport(s.etd);
            const etaFormatted = formatDateExport(s.eta);
            const transbordoDateFormatted = formatDateExport(s.transbordoDate);
...
// Função de formatação para export
