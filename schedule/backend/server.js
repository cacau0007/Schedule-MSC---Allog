...
// ============================================
// EXCEL - Geração simplificada e robusta
// ============================================
async function generateExcel(sailings, pol, pod, filename) {
    ...
    titleCell.value = `ALLOG - Shipping Schedules: ${pol} - ${pod}`;
    titleCell.font = { bold: true, size: 14 };
    titleCell.alignment = { horizontal: 'center' };
    
    // Headers
    const headers = ['CARRIER', 'SERVICO', 'NAVIO', 'ETD', 'ETA', 'TRANSIT', 'TIPO', 'TRANSBORDO'];
    sheet.addRow(headers);
    
    // Sanitizar string - remove caracteres problemáticos
    ...
    // Salvar usando buffer primeiro (mais confiável)
