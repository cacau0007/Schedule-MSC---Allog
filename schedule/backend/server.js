...
const SERVICE_ROUTES = {
    ...
    // Shanghai-Navegantes tem: Ipanema (direto), Santana (transbordo), Jade (transbordo), Carioca (direto após set/2024)
    'Shanghai-Navegantes': ['Ipanema', 'Santana', 'Jade', 'Carioca'],
    'Ningbo-Navegantes': ['Ipanema', 'Carioca', 'Jade'],
    'Busan-Navegantes': ['Ipanema', 'Carioca'],
    'Qingdao-Navegantes': ['Carioca', 'Ipanema'],
    'Shekou-Navegantes': ['Ipanema', 'Carioca'],
    'Hong Kong-Navegantes': ['Ipanema'],
    'Singapore-Navegantes': ['Ipanema'],
    'Yantian-Navegantes': ['Carioca', 'Ipanema'],
    'Xiamen-Navegantes': ['Jade', 'Tiger', 'Ipanema'],
    'Tianjin-Navegantes': ['Jade', 'Tiger', 'Santana', 'Carioca', 'Ipanema'],
