...
const SERVICE_ROUTES = {
    ...
    // Shanghai → PODs (Santana + outros)
    'Shanghai-Santos': ['Santana', 'Carioca', 'Ipanema', 'Jade'],
    'Shanghai-Itapoa': ['Santana', 'Carioca'],
    'Shanghai-Rio de Janeiro': ['Santana', 'Carioca'],
    'Shanghai-Paranagua': ['Santana', 'Carioca', 'Ipanema'],
    'Shanghai-Navegantes': ['Santana', 'Ipanema'],
    'Shanghai-Imbituba': ['Santana'],
    'Shanghai-Itajai': ['Santana'],
    'Shanghai-Itaguai': ['Santana', 'Carioca'],
    
    // Ningbo → PODs (Santana + outros)
    'Ningbo-Santos': ['Santana', 'Carioca', 'Ipanema', 'Jade'],
    'Ningbo-Itapoa': ['Santana', 'Carioca'],
    'Ningbo-Rio de Janeiro': ['Santana', 'Carioca'],
    'Ningbo-Paranagua': ['Santana', 'Carioca', 'Ipanema'],
    'Ningbo-Navegantes': ['Santana', 'Ipanema'],
    'Ningbo-Imbituba': ['Santana'],
    'Ningbo-Itajai': ['Santana'],
    'Ningbo-Itaguai': ['Santana', 'Carioca'],
    
    // Qingdao → PODs (Santana + Carioca)
    'Qingdao-Santos': ['Santana', 'Carioca'],
    'Qingdao-Itapoa': ['Santana', 'Carioca'],
    'Qingdao-Rio de Janeiro': ['Santana', 'Carioca'],
    'Qingdao-Paranagua': ['Santana', 'Carioca'],
    'Qingdao-Navegantes': ['Santana'],
    'Qingdao-Imbituba': ['Santana'],
    'Qingdao-Itaguai': ['Santana', 'Carioca'],
    
    // Busan → PODs (Santana + Carioca + Ipanema)
    'Busan-Santos': ['Santana', 'Carioca', 'Ipanema'],
    'Busan-Itapoa': ['Santana', 'Carioca'],
    'Busan-Rio de Janeiro': ['Santana', 'Carioca'],
    'Busan-Paranagua': ['Santana', 'Carioca', 'Ipanema'],
    'Busan-Navegantes': ['Santana', 'Ipanema'],
    ...
    // Shekou → PODs (Santana + Carioca + Ipanema)
    'Shekou-Santos': ['Santana', 'Carioca', 'Ipanema'],
    'Shekou-Rio de Janeiro': ['Santana', 'Carioca'],
    'Shekou-Paranagua': ['Santana', 'Carioca', 'Ipanema'],
    'Shekou-Navegantes': ['Santana', 'Ipanema'],
    ...
    // Singapore → PODs (Santana + Carioca + Ipanema)
    'Singapore-Santos': ['Santana', 'Carioca', 'Ipanema'],
    'Singapore-Itapoa': ['Santana', 'Carioca'],
    'Singapore-Rio de Janeiro': ['Santana', 'Carioca'],
    'Singapore-Paranagua': ['Santana', 'Ipanema'],
    'Singapore-Navegantes': ['Santana', 'Ipanema'],
    ...
    // Jade para Nordeste (via T/S Sines ou Valência)
    'Shanghai-Suape': ['Jade'],
