...
// ANÁLISE DO PDF:
// 
// CARIOCA → PODs: Santos, Rio de Janeiro, Paranaguá, Itapoá, Itaguaí
//           POLs Diretos: Shanghai, Ningbo, Shekou, Busan, Singapore, Qingdao
//           POLs Conexão (via SIN): Jakarta, Surabaya, Laem Chabang, Haiphong, Ho Chi Minh, Port Klang
//           POLs Conexão (via BUS): Xingang/Tianjin, Dalian, Yokohama, Tokyo
//
// IPANEMA → PODs: Santos, Paranaguá, Navegantes, Montevideo, Buenos Aires, Rio Grande
//           POLs Diretos: Shanghai, Ningbo, Shekou, Yantian, Hong Kong, Singapore
//           POLs Conexão (via SIN): Jakarta, Surabaya, Laem Chabang, Haiphong, Ho Chi Minh, Port Klang
//           POLs Conexão (via BUS): Xingang/Tianjin, Dalian, Yokohama, Tokyo
//
// SANTANA → PODs: Rio de Janeiro, Santos, Paranaguá, Navegantes, Imbituba, Itajaí, Itaguaí
//           POLs Diretos: Qingdao, Busan, Shanghai, Ningbo, Shekou, Singapore
//           POLs Conexão (via SIN): Jakarta, Surabaya, Laem Chabang, Haiphong, Ho Chi Minh, Bangkok, Port Klang
//           POLs Conexão (via BUS): Xingang/Tianjin, Dalian, Incheon
//
// JADE → PODs: Santos, Navegantes, Paranaguá, Rio de Janeiro (via T/S Sines/Valência)
//        POLs: Xiamen, Nansha, Fuzhou, Kaohsiung
//        Também: Shanghai/Ningbo → Suape/Salvador (via T/S Sines)
// ============================================

const SERVICE_ROUTES = {
    // ========================================================
    // SANTOS - Carioca, Ipanema, Santana, Jade(alguns)
    // ========================================================
    ...
    // ========================================================
    // RIO DE JANEIRO - Carioca, Santana, Jade(alguns)
    // (Ipanema NÃO atende Rio de Janeiro!)
    // ========================================================
    ...
    // ========================================================
    // PARANAGUÁ - Carioca, Ipanema, Santana, Jade(alguns)
    // ========================================================
    ...
    // ========================================================
    // NAVEGANTES - Ipanema, Santana, Jade(alguns)
    ...
    'Surabaya-Itapoa': ['Carioca'],
    'Laem Chabang-Itapoa': ['Carioca'],
    'Haiphong-Itapoa': ['Carioca'],
    'Ho Chi Minh-Itapoa': ['Carioca'],
    'Port Klang-Itapoa': ['Carioca'],
    // Conexões via Busan
    'Tianjin-Itapoa': ['Carioca'],
    'Xingang-Itapoa': ['Carioca'],
    'Dalian-Itapoa': ['Carioca'],
    'Yokohama-Itapoa': ['Carioca'],
    'Tokyo-Itapoa': ['Carioca'],

    // ========================================================
    // ITAGUAÍ - Carioca e Santana
    // ========================================================
    ...
    'Surabaya-Itaguai': ['Carioca', 'Santana'],
    'Laem Chabang-Itaguai': ['Carioca', 'Santana'],
    'Haiphong-Itaguai': ['Carioca', 'Santana'],
    'Ho Chi Minh-Itaguai': ['Carioca', 'Santana'],
    'Port Klang-Itaguai': ['Carioca', 'Santana'],
    // Conexões via Busan
    'Tianjin-Itaguai': ['Carioca', 'Santana'],
    'Xingang-Itaguai': ['Carioca', 'Santana'],
    'Dalian-Itaguai': ['Carioca', 'Santana'],

    // ========================================================
    // IMBITUBA - Apenas Santana
    // ========================================================
    ...
    // Conexões via Singapore
    'Jakarta-Imbituba': ['Santana'],
    'Surabaya-Imbituba': ['Santana'],
    'Laem Chabang-Imbituba': ['Santana'],
    'Haiphong-Imbituba': ['Santana'],
    'Ho Chi Minh-Imbituba': ['Santana'],
    'Port Klang-Imbituba': ['Santana'],
    // Conexões via Busan
    'Tianjin-Imbituba': ['Santana'],
    'Xingang-Imbituba': ['Santana'],
    'Dalian-Imbituba': ['Santana'],

    // ========================================================
    // ITAJAÍ - Apenas Santana
    // ========================================================
    ...
    // Conexões via Singapore
    'Jakarta-Itajai': ['Santana'],
    'Surabaya-Itajai': ['Santana'],
    'Laem Chabang-Itajai': ['Santana'],
    'Haiphong-Itajai': ['Santana'],
    'Ho Chi Minh-Itajai': ['Santana'],
    'Port Klang-Itajai': ['Santana'],
    // Conexões via Busan
    'Tianjin-Itajai': ['Santana'],
    'Xingang-Itajai': ['Santana'],
    'Dalian-Itajai': ['Santana'],

    // ========================================================
    // MONTEVIDEO - Apenas Ipanema
    // ========================================================
    ...
    // Conexões
    'Jakarta-Montevideo': ['Ipanema'],
    'Surabaya-Montevideo': ['Ipanema'],
    'Laem Chabang-Montevideo': ['Ipanema'],
    'Haiphong-Montevideo': ['Ipanema'],
    'Ho Chi Minh-Montevideo': ['Ipanema'],
    'Port Klang-Montevideo': ['Ipanema'],
    'Tianjin-Montevideo': ['Ipanema'],
    'Xingang-Montevideo': ['Ipanema'],
    'Dalian-Montevideo': ['Ipanema'],
    'Yokohama-Montevideo': ['Ipanema'],
    'Tokyo-Montevideo': ['Ipanema'],

    // ========================================================
    // BUENOS AIRES - Apenas Ipanema
    // ========================================================
    ...
    // Conexões
    'Jakarta-Buenos Aires': ['Ipanema'],
    'Surabaya-Buenos Aires': ['Ipanema'],
    'Laem Chabang-Buenos Aires': ['Ipanema'],
    'Haiphong-Buenos Aires': ['Ipanema'],
    'Ho Chi Minh-Buenos Aires': ['Ipanema'],
    'Port Klang-Buenos Aires': ['Ipanema'],
    'Tianjin-Buenos Aires': ['Ipanema'],
    'Xingang-Buenos Aires': ['Ipanema'],
    'Dalian-Buenos Aires': ['Ipanema'],
    'Yokohama-Buenos Aires': ['Ipanema'],
    'Tokyo-Buenos Aires': ['Ipanema'],

    // ========================================================
    // RIO GRANDE - Apenas Ipanema
    // ========================================================
    ...
    // Conexões
    'Jakarta-Rio Grande': ['Ipanema'],
    'Surabaya-Rio Grande': ['Ipanema'],
    'Laem Chabang-Rio Grande': ['Ipanema'],
    'Haiphong-Rio Grande': ['Ipanema'],
    'Ho Chi Minh-Rio Grande': ['Ipanema'],
    'Port Klang-Rio Grande': ['Ipanema'],
    'Tianjin-Rio Grande': ['Ipanema'],
    'Xingang-Rio Grande': ['Ipanema'],
    'Dalian-Rio Grande': ['Ipanema'],
    'Yokohama-Rio Grande': ['Ipanema'],
    'Tokyo-Rio Grande': ['Ipanema'],

    // ========================================================
    // SUAPE e SALVADOR - Jade (via T/S Sines)
    // ========================================================
    'Shanghai-Suape': ['Jade'],
    'Ningbo-Suape': ['Jade'],
